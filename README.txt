...
In both the applications I am taking in command line arguments to create stream or datagram socket. Depending on your choice you can use the application programs provided to create either of the sockets for server as well as client. Both the sockets are an example of a very basic socket implementation.
